...
CharacterDataStruct JSONParser::parseCharacterData(const std::array<char, max_length> &dataBuffer, size_t bytes_transferred)
{
    ...
    if (jsonData.contains("body") &&
        jsonData["body"].is_object() &&
        jsonData["body"].contains("characterGender") &&
        jsonData["body"]["characterGender"].is_string())
    {
        characterData.characterGender = jsonData["body"]["characterGender"].get<std::string>();
    }
...
PositionStruct JSONParser::parsePositionData(const std::array<char, max_length> &dataBuffer, size_t bytes_transferred)
{
    ...
    if (jsonData.contains("body") &&
        ...
        jsonData["body"]["characterPosX"].is_number_integer())
    {
    ...
    if (jsonData.contains("body") &&
        ...
        jsonData["body"]["characterPosY"].is_number_integer())
    {
    ...
    if (jsonData.contains("body") &&
        ...
        jsonData["body"]["characterPosZ"].is_number_integer())
    {
...
ClientDataStruct JSONParser::parseClientData(const std::array<char, max_length> &dataBuffer, size_t bytes_transferred)
{
    ...
    if (jsonData.contains("body") &&
        jsonData["body"].is_object() &&
        jsonData["body"].contains("login") &&
        jsonData["body"]["login"].is_string())
    {
        clientData.login = jsonData["body"]["login"].get<std::string>();
    }

    if (jsonData.contains("body") &&
        jsonData["body"].is_object() &&
        jsonData["body"].contains("password") &&
        jsonData["body"]["password"].is_string())
    {
