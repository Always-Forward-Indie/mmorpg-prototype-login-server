...
{
public:
    LoginServer(ClientData &clientData, CharacterManager &characterManager, Database &database, std::tuple<DatabaseConfig, LoginServerConfig> &configs, Logger &logger);
    ~LoginServer();
